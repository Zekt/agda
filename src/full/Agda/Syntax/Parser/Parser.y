...
UnquoteDecl
  ...
  | 'unquoteDecl' 'data' Id '=' Expr { UnquoteData (getRange($1, $2, $3, $5)) $3 [] $5 }
  | 'unquoteDecl' 'data' Id 'constructor' SpaceIds '=' Expr { UnquoteData (getRange($1, $2, $3, $4, $5, $7)) $3 (List1.toList $5) $7 }
